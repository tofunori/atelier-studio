    ...
    <TooltipProvider delay={0}>
      <Tooltip>
        <TooltipTrigger render={<Button variant="ghost" size="icon" {...rest} className={cn(
                            "aui-button-icon tw:size-6 tw:p-1 tw:active:scale-90",
                            className,
                          )} ref={ref} />}><Slot.Slottable>{children}</Slot.Slottable><span className="aui-sr-only tw:sr-only">{tooltip}</span></TooltipTrigger>
