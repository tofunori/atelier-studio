...
import {
  InputGroup,
  InputGroupAddon,
} from "@/components/assistant-ui/primitives/input-group"
...
function CommandShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        "tw:ml-auto tw:text-xs tw:tracking-widest tw:text-muted-foreground tw:group-data-selected/command-item:text-foreground",
        className
      )}
      {...props}
    />
