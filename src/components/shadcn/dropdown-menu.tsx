...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuContent
      ...
      className={cn("tw:w-auto tw:min-w-[96px] tw:rounded-[var(--radius-surface)] tw:bg-popover tw:p-1 tw:text-popover-foreground tw:shadow-[var(--elevation-overlay)] tw:ring-1 tw:ring-foreground/10", className)}
      align={align}
      alignOffset={alignOffset}
      side={side}
      sideOffset={sideOffset}
...
function DropdownMenuShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        "tw:ml-auto tw:text-[length:var(--fs-caption)] tw:tracking-widest tw:text-muted-foreground tw:group-focus/dropdown-menu-item:text-accent-foreground",
        className
      )}
      {...props}
    />
