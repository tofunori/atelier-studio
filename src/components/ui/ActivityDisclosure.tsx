...
export function ActivityDisclosure({ open, onToggle, label, meta, icon, status = "completed", children, summary = false, shimmer = false }:
  { open: boolean; onToggle: () => void; label: ReactNode; meta?: ReactNode; icon?: ActivityIcon;
    status?: "running" | "completed" | "failed"; children?: ReactNode; summary?: boolean; shimmer?: boolean }) {
  return (
    <Collapsible
