...
(function(){
  ...
  var CSS =
    ...
    +'gap:6px;align-items:center;background:rgba(20,23,30,.95);border:1px solid #3a4150;'
    +'border-radius:10px;padding:6px 10px;font:13px -apple-system,system-ui,sans-serif;color:#e4e4e7}'
    +'.akBar.on{display:flex}'
    +'.akBar button{padding:5px 9px;font-size:13px;background:transparent;color:#e4e4e7;'
    +'border:1px solid #3a4150;border-radius:7px;cursor:pointer}'
