...
(function(){
  ...
  function attach(opts){
    ...
    if (EMBEDDED){
      ...
      go.style.cssText = "width:34px;min-width:34px;height:34px;border-radius:8px;padding:0;font-size:var(--fs-body, 13px);white-space:nowrap;background:#2c313a;color:#dbdfe5;border:1px solid #3a414d;box-shadow:0 6px 18px rgba(0,0,0,0.5);cursor:pointer";
