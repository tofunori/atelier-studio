...
(function(){
  ...
  var CSS =
    ...
    +'gap:2px;align-items:center;background:var(--card,rgba(26,29,34,.92));backdrop-filter:blur(10px);border:1px solid var(--border,#333a45);'
    +'border-radius:10px;padding:4px 6px;font:13px -apple-system,system-ui,sans-serif;color:var(--txt,#dbdfe5)}'
    +'.akBar.on{display:flex}'
    +'.akBar button{padding:0;width:26px;height:24px;font-size:12px;background:transparent;color:var(--muted,#868d9a);display:inline-flex;align-items:center;justify-content:center;'
    ...
    +'box-shadow:0 12px 36px rgba(0,0,0,.45);font:13px -apple-system,system-ui,sans-serif;color:var(--txt,#e6e7ea)}'
    +'.akNote .nb{color:var(--muted,#868d9a);font-size:12px;font-weight:600;flex:none;display:flex;align-items:center;padding:0 12px;background:#262b31;border-right:1px solid var(--border,#333a45)}'
    ...
    +'padding:7px 7px 7px 18px;box-shadow:0 10px 36px rgba(0,0,0,.5);color:var(--txt,#dbdfe5);font:13.5px -apple-system,system-ui,sans-serif}'
    ...
    +'.akPill .x{width:28px;height:28px;border-radius:50%;background:transparent;color:var(--muted,#9aa3b2);'
    +'border:1px solid var(--border,#3a4150);font-size:13px}'
    +'.akPill .x:hover{border-color:#5b6575;color:#fff}'
    +'.akPill .go{width:32px;height:32px;border-radius:50%;background:var(--accent,#c96442);color:#fff;font-size:15px}'
    +'.akPill .go:hover{background:#e0714a}'
    +'.akPill .tg{width:28px;height:28px;border-radius:50%;background:transparent;color:var(--muted,#9aa3b2);'
    +'border:1px solid var(--border,#3a4150);font-size:13px}'
    ...
    +'background:var(--card,rgba(24,27,34,.98));border:1px solid var(--border,#3a4150);border-radius:10px;padding:6px;'
    +'box-shadow:0 14px 48px rgba(0,0,0,.55);font:12.5px -apple-system,system-ui,sans-serif;color:var(--txt,#dbdfe5)}'
    +'.akTgMenu .it{display:flex;gap:8px;align-items:center;padding:7px 9px;border-radius:10px;cursor:pointer}'
    +'.akTgMenu .it:hover{background:rgba(255,255,255,.06)}'
    +'.akTgMenu .it .app{flex:none;font-size:10px;font-weight:600;letter-spacing:.05em;text-transform:uppercase;'
    ...
    +'.akTgMenu .hd{font-size:11px;color:var(--muted,#9aa3b2);text-transform:uppercase;letter-spacing:.05em;padding:5px 9px 3px}';
