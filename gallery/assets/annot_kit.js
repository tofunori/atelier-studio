...
(function(){
  ...
  var CSS =
    ...
    +'border-radius:10px;padding:4px 6px;font:13px -apple-system,system-ui,sans-serif;color:#dbdfe5}'
    +'.akBar.on{display:flex}'
    +'.akBar button{padding:0;width:26px;height:24px;font-size:12px;background:transparent;color:#868d9a;display:inline-flex;align-items:center;justify-content:center;'
    +'border:none;border-radius:6px;cursor:pointer}'
    +'.akBar button:hover{background:#2c313a;color:#dbdfe5}'
    +'.akBar button.sel{background:#2c313a;color:#dbdfe5;border:none}'
    ...
    +'.akNote .nb{color:#868d9a;font-size:12px;font-weight:600;flex:none;display:flex;align-items:center;padding:0 12px;background:#262b31;border-right:1px solid #333a45}'
    ...
    +'.akNote .del{width:36px;border-radius:0;background:none;border:none;border-left:1px solid #333a45;color:#646d7b;'
    ...
    +'.akNote .anSave{width:36px;border-radius:0;background:none;color:#b6bdc7;border:none;border-left:1px solid #333a45;'
    ...
    +'align-items:center;gap:12px;background:rgba(24,27,34,.97);border:1px solid #3a4150;border-radius:999px;'
    +'padding:7px 7px 7px 18px;box-shadow:0 10px 36px rgba(0,0,0,.5);color:#dbdfe5;font:13.5px -apple-system,system-ui,sans-serif}'
    ...
    +'.akPill .go{width:32px;height:32px;border-radius:50%;background:#c96442;color:#fff;font-size:15px}'
    ...
    +'box-shadow:0 14px 48px rgba(0,0,0,.55);font:12.5px -apple-system,system-ui,sans-serif;color:#dbdfe5}'
    ...
    +'.akTgMenu .hd{font-size:11px;color:#9aa3b2;text-transform:uppercase;letter-spacing:.05em;padding:5px 9px 3px}';
