...
The following 68 product and engineering commits are included after `v1.3.5`. Descriptions are normalized into English; hashes link the ledger to the immutable Git history.
...
68. `4f0e8c7f` — Applied an explicit ad hoc signature to public macOS bundles and blocked publication unless strict deep code-signature verification succeeds.
