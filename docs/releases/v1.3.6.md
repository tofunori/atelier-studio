...
The following 66 product and engineering commits are included after `v1.3.5`. Descriptions are normalized into English; hashes link the ledger to the immutable Git history.
